...
return {
    ...
    j_rugpull = {
        text = {
            { text = "+$" },
            { ref_table = "card.ability", ref_value = "dollars" }
        },
        text_config = { colour = G.C.GOLD }
    },
    j_zombie_joker = {
        text = {
            { ref_table = "card.ability", ref_value = "hand" },
            { text = "H, " },
            { ref_table = "card.ability", ref_value = "card" },
            { text = "C" }
        },
    },
    j_lithograph = {
    ...
    j_president_joker = {
        ...
        calc_function = function(card)
            ...
            local is_clone = card.ability.name ~= 'President Joker'
            card.joker_display_values.hide = is_negative or is_clone
            ...
            if is_negative then
                ...
                card.joker_display_values.x_mult = 1 + count * (card.ability.extra.mult_gain or 0.5)
            end
        end,
        style_function = function(card, text, reminder_text, extra)
            if text and text.UIBox then
                text.UIBox.states.visible = not card.joker_display_values.hide
            end
        end
    },
    j_super_joker = {
