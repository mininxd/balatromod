    ...
    local config = {
        {
            ...
            nodes = {
                ...
                -- Right Column: Joker Display Preview
                {
                    n = G.UIT.C,
                    config = { align = "ct", padding = 0.05, no_fill = true },
                    nodes = {
